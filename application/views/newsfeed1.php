    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="widget-container">
          <div class="padded"> <a href="#" class="pull-right"><i class="icon-map-marker"></i></a> <span class="h4"></span>
            <div class="text-center padder m-t"> <span class="h3">Seattle, WA</span> </div>
            ...
            <div class = "row">
                <div id='front'>
                  ...
                  <div id='front-panel'>
                    ...
                    <div id='bottom' class='background'>
                    </div>
    ...
    <div class = "row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="widget-container">
          <div class="panel-body"> <a class="thumb pull-left m-r" href="#"> <img class="img-circle" src="<?php echo base_url();?>assets1/images/user.jpg"></a>
            <div class="clear"> <a class="text-info" href="#">@Twitter feed <i class="icon-twitter"></i></a> <small class="block text-muted">7,257 followers / 342 tweets</small> <a class="btn btn-xs btn-info m-t-xs" href="#">Follow</a> </div>
          </div>
        </div>
      </div>
    </div>
