...
<div class="login-logo">
	<img src="<?php echo base_url();?>assets1/images/logo.png" width="200" height="60">
    </div>

<div class="widget">
<div class="login-content">
  <div class="widget-content" style="padding-bottom:0;">
  <form method="get" action="<?php echo base_url(); ?>Login/login1" class="no-margin">
                <h3 class="form-title">Login to 502 - dashboard</h3>
