(function(d) {
  ...
  e.prototype.load=function(a)
  {
    ...
    null!==this.options.key&&(b+="&key="+this.options.key);d.getJSON(b,a)
  };
  ...
  e.prototype.applyEffect=function(a,b,c)
  {
    switch(b)
    {
      case "slide":a.slideDown("slow",c);
      break;
      case "slideFast":a.slideDown(c);
      break;
      case "slideSynced":this.effectQueue.push({element:a,effect:"slide"});
      break;
      case "slideFastSynced":this.effectQueue.push({element:a,effect:"slideFast"})
    }
  };
  ...
  e.prototype.getValueForToken=function(a,b)
  {
    ...
    return"function"===typeof d?d(b,c):d;
