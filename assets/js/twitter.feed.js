...
*  Coded by Tinh Nguyen 2017.
*  http://leafchief.com/dashboard/
*********************************************************************/
...
if(showImages&&images[n]!==undefined&&extractImageUrl(images[n])!==undefined){op+='<div class="image">'+'<img src="'+extractImageUrl(images[n])+'" alt="Image from tweet" />'+'</div>'}
...
// id "twitter-feeds". Also automatically hyperlinks URLS and user mentions and
// hashtags.
var configProfile = {
  "profile": {"screenName": 'leaf__chief'},
  "domId": 'twitter-feeds',
  "maxTweets": 10,
  "enableLinks": true,
  "showUser": true,
